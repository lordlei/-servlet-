	...
	<head>
		...
		<script type="text/javascript">
			function delItem(pid) {
			    if (confirm("你是否删除该项商品吗")){
			        location.href="${pageContext.request.contextPath}/product?method=delItem&pid="+pid;
				}
            }
            
            function clearCart() {
                if (confirm("你是否清空购物车吗")){
						...
						<table class="table table-bordered">
							...
							<c:forEach items="${cart.cartItems}" var="entry">
								...
								<tr class="active">
									...
									<td>
										<a href="javascript:void(0);" onclick="delItem('${entry.value.product.pid}')"
										   class="delete">删除</a>
									</td>
								</tr>
